    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievements', models.ManyToManyField(blank=True, related_name='profiles', to='myapp.achievement')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='user',
            name='blocked_users',
            field=models.ManyToManyField(blank=True, related_name='blocked_users', to='myapp.blockeduser'),
        ),
        migrations.CreateModel(
            name='Friend',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friends_set', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-date'],
            },
        ...
        migrations.AddField(
            model_name='user',
            name='friends',
            field=models.ManyToManyField(blank=True, related_name='user_friends', to='myapp.friend'),
        ),
        migrations.CreateModel(
            name='FriendRequest',
            fields=[
        ...
        migrations.AddField(
            model_name='user',
            name='fiend_requests',
            field=models.ManyToManyField(blank=True, related_name='friend_requests', to='myapp.friendrequest'),
        ),
    ]
