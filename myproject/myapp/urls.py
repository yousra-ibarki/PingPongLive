...
from myapp.views import TOTPVerifyView,TOTPSetupView, TOTPDisableView, TOTStatusView, CustomLoginView, AchievementsView, ChangePasswordView, UsersView, UnblockUserView, BlockUserView, FriendRequestsView, SendFriendRequestView, \
                SendNotificationMessageView, GameResponseView, SendGameRequestView, FriendshipStatusView, RemoveFriendshipView, FriendsView, LoginView42, LoginCallbackView, LogoutView, ListUsers, UserRetrieveAPIView, UserUpdateAPIView, RegisterView, RefreshTokenView, UserProfileView
...
urlpatterns = [
    ...
    path('api/game/response/<int:id>/', GameResponseView.as_view(), name='game_response'),
    path('api/chat/notify_chat_message/<int:id>/', SendNotificationMessageView.as_view(), name='send_chat_message'),
