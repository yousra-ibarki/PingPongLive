...
from myapp.views import AchievementsView, MatchHistoryView, LoginView, ChangePasswordView, TwoFactorLoginView, LoginView42, LoginCallbackView, LogoutView, ProfileView, ManageProfileView, ListUsers, UserRetrieveAPIView, UserUpdateAPIView, ProfileAccountView, RegisterView, RefreshTokenView, UserProfileView
...
urlpatterns = [
    ...
    # path('api/MatchHistory/', MatchHistoryView.as_view(), name='match_history'),
]
