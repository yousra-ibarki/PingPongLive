        ...
        async with self.__class__.lock:
            ...
            if(player_ready2_id):
                ...
                if waiting_player_id == player_id:
                    self.__class__.waiting_players[waiting_player_id] = (waiting_player_channel, waiting_player_name)
                    await self.send_json({
                        'type': 'error',
                ...
                self.__class__.rooms[room_name] = [
                    {"id": player_id, "name": player_ready1_id, "channel_name": self.channel_name},
                    {"id": waiting_player_id, "name": waiting_player_name, "channel_name": waiting_player_channel},
                ]
