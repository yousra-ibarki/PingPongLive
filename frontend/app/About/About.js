  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="flex flex-wrap justify-center space-x-6 mt-[300px]">
        {/* First card */}
        <div className="w-64 h-[500px] bg-black shadow-xl shadow-black rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 opacity-0 fade-in group" style={{ animationDelay: '0s'}}>
          <img
      ...
      <div className="space-y-6 text-white text-xs">
        {/* GitHub */}
        <a href="https://github.com/Scha77en" target="_blank" className="flex items-center space-x-2">
        ...
        {/* LinkedIn */}
        <a href="https://www.linkedin.com/in/abdellah-ouhbi/" target="_blank" className="flex items-center space-x-2">
        ...
        {/* Email */}
        <a href="mailto:abdououhbi1@gmail.com" target="_blank" className="flex items-center space-x-2">
      ...
      <div className="absolute bottom-4 text-white font-serif text-sm">
        ...
        {/* Second card (lowered) */}
        <div className="w-64 h-[500px] bg-black shadow-xl shadow-black rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 mt-20 opacity-0 fade-in group" style={{ animationDelay: '0.4s'}}>
          <img
            className="h-full w-full object-cover hover:blur-sm transition duration-300 group-hover:blur-sm"
            src="image2.jpeg"
            alt="Card 2"
      ...
      <div className="absolute bottom-4 text-white font-serif text-sm">
        ...
        {/* Third card */}
        <div className="w-64 h-[500px] bg-black shadow-xl shadow-black rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 opacity-0 fade-in group" style={{ animationDelay: '0.8s'}}>
          <img
            className="h-full w-full object-cover hover:blur-sm transition duration-300 group-hover:blur-sm"
            src="image3.jpeg"
            alt="Card 3"
      ...
      <div className="absolute bottom-4 text-white font-serif text-sm">
        ...
        {/* Fourth card (lowered) */}
        <div className="w-64 h-[500px] bg-black shadow-xl shadow-black rounded-lg overflow-hidden mt-20 transform transition-transform duration-300 hover:scale-105 opacity-0 fade-in group" style={{ animationDelay: '1.2s'}}>
          <img
            className="h-full w-full object-cover hover:blur-sm transition duration-300 group-hover:blur-sm"
            src="image4.jpeg"
            alt="Card 4"
      ...
      <div className="absolute bottom-4 text-white font-serif text-sm">
        ...
        {/* Fifth card */}
        <div className="w-64 h-[500px] bg-black shadow-xl shadow-black rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 opacity-0 fade-in group" style={{ animationDelay: '1.6s'}}>
          <img
            className="h-full w-full object-cover hover:blur-sm transition duration-300 group-hover:blur-sm"
            src="image5.jpeg"
            alt="Card 5"
