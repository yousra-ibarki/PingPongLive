...
export const GameResultModal = ({setEndModel, winnerScore, loserScore}) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-90 backdrop-blur-sm flex items-center justify-center">
      <div className="bg-gradient-to-b from-indigo-900 to-purple-900 rounded-3xl p-8 max-w-5xl w-full mx-4 shadow-2xl border-4 border-pink-500">
        <div className="flex justify-end">
          <button  onClick={() => setEndModel(false)} className="text-pink-400 hover:text-pink-300">
            <X size={24} />
          </button>
        </div>
        ...
        <div className="flex justify-between items-center gap-8">
          {/* Winner Side */}
          <div className="flex-1 bg-gradient-to-br from-yellow-400 via-orange-500 to-pink-600 rounded-2xl p-8 
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-yellow-100 text-xl mt-2">
                "TOO EASY! 😎"
              </div>
            </div>
          </div>
          ...
          {/* VS Section */}
          <div className="text-7xl font-black text-pink-500 px-6 animate-pulse rotate-12">
            VS
          </div>
