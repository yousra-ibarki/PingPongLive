    ...
    const fetchUserData = async () => {
      try {
        ...
        setUserData({
          ...
          history: [
            { result: "WIN", opponent: { name: "Opponent", image: "/avatars/defaultAv_1.jpg" },
              date : "2021-10-10" },
            { result: "LOSE", opponent: { name: "Opponent", imag: null }, 
              date : "2021-10-10" },
            { result: "win", opponent: { name: "Opponent", image: null }, 
              date : "2021-10-10" },
            { result: "WIN", opponent: { name: "Opponent", image: null }, 
              date : "2021-10-10" },
            { result: "LOSE", opponent: { name: "Opponent", imag: null }, 
