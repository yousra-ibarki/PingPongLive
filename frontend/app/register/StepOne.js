...
const StepOne = ({ userData, setUserData, error, loading, onNext }) => {
  ...
  return (
    // <div className="flex justify-center items-center h-[1000px] bg-[#222831] p-4">
      <div className=" w-full max-w-lg bg-[#393E46] p-6 rounded-lg shadow-lg flex flex-col justify-center items-center border border-[#FFD369] ">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-[70%] py-2 mt-4 bg-[#FFD369] text-[#222831] font-kreon text-lg rounded-lg hover:bg-[#e6bf56] transition duration-300"
          >
            {loading ? (
